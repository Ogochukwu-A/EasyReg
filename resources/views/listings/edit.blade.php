<x-layout>
  <x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
      <h2 class="text-2xl font-bold uppercase mb-1">Edit Innovation</h2>
    ...
    <form method="POST" action="/listings/{{$listing->id}}" enctype="multipart/form-data">
      ...
      @method('PUT')
      <div class="mb-6">
        <label for="company" class="inline-block text-lg mb-2">Innovation Name</label>
        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="innovation"
          value="{{$listing->innovation}}" />
      ...
      <div class="mb-6">
        <label for="title" class="inline-block text-lg mb-2">Topic</label>
